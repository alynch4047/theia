...
import {
    ...
    FileSystemProviderWithFileFolderCopyCapability, FileSystemProviderWithOpenReadWriteCloseCapability
}
...
export class LdfCommandContribution implements CommandContribution {
    ...
    registerCommands(registry: CommandRegistry): void {
        registry.registerCommand(LdfCommand, {
            execute: () => this.messageService.info('Hello World 19!')
        });
...
@injectable()
export class LifionFileSystemProvider implements Disposable, FileSystemProvider, FileSystemProviderWithFileReadWriteCapability,
    FileSystemProviderWithOpenReadWriteCloseCapability, FileSystemProviderWithFileFolderCopyCapability {
